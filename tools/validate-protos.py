...
FIXTURE_TO_MESSAGE = {
    ...
    'packet-type-advert.json': ('PacketDetailResponse', 'object'),
    'packet-type-grptxt-decrypted.json': ('PacketDetailResponse', 'object'),
    'packet-type-grptxt-undecrypted.json': ('PacketDetailResponse', 'object'),
    'packet-type-txtmsg.json': ('PacketDetailResponse', 'object'),
    'packet-type-req.json': ('PacketDetailResponse', 'object'),
